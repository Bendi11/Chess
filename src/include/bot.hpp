...
namespace Bot //Namespace containing all bot objects
{
    ...
    public:
        ...
        void stockfishMove(Chess::board_t& Board, std::string& record, std::ofstream& write, unsigned int difficulty, renderer::Drawer& d); //Function to start stockfish process
    };
}